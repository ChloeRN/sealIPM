...
seal.constants <- list(
  ...
  S_pup.lLimit = 0.2, # Lower limit for baseline pup survival
  S_pup.uLimit = 0.8 # Upper limit for baseline pup survival
)
...
save(testRun, file = '220125_Seal_IPM_noPeriodEff_unknownSpup_Test.RData')

pdf('220125_IPMtest_noPeriodEff_unknownSpup_Traces.pdf', height = 8, width = 11)
plot(testRun)
dev.off()
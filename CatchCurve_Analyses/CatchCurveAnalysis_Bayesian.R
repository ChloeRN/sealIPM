...
for(i in 1:8){
  ...
  ## Truncate dataset
  #  Start age = 1, because sampling of pups (Age 0) is unlikely to be representative
  AaH.data <- subset(AaH.data, Age > 0)
...
## Save MCMC data
saveRDS(CCA.MCMC, file = 'CatchCurve_Analyses/CatchCurveAnalysis_MCMC.rds')

...
sam.LTA <- readRDS('220118_LifeTableAnalysis_MCMC.rds')
sam.CCA <- readRDS('220118_CatchCurveAnalysis_Truncated_MCMC.rds')
sam.HOE <- readRDS('220119_mO_HoeningSim.rds')
...
pdf('220121_SurvPriors_All_MethodComp.pdf', width = 10, height = 7.5)
...
pdf('220121_SurvPriors_MA_MethodComp.pdf', width = 8, height = 5)
...
pdf('220121_SurvPriors_F_MA_MethodComp.pdf', width = 8, height = 5)
...
## Plot posterior distributions for all survival rates
pdf('220121_SurvPriors_All_IndepVSInt2.pdf', width = 10, height = 10)
...
## "Zoom in" on posterior distributions for adults survival rate
pdf('220121_SurvPriors_MA_IndepVSInt2.pdf', width = 8, height = 5)
